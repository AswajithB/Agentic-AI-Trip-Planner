...
class PlaceSearchTool:
    def __init__(self):
        ...
        logger.info("PlaceSearchTool initialized")
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                ...
                logger.warning(f"Google search failed for attractions in {place}: {e}. Falling back to Tavily.")
        ...
        def search_restaurants(place:str) -> str:
            ...
            try:
                ...
                logger.warning(f"Google search failed for restaurants in {place}: {e}. Falling back to Tavily.")
        ...
        def search_activities(place:str) -> str:
            ...
            try:
                ...
                logger.warning(f"Google search failed for activities in {place}: {e}. Falling back to Tavily.")
        ...
        def search_transportation(place:str) -> str:
            ...
            try:
                ...
                logger.warning(f"Google search failed for transportation in {place}: {e}. Falling back to Tavily.")
